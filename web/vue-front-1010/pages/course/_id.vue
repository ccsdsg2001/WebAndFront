<template>
    <div id="aCoursesList" class="bg-fa of">
      ...
      <section class="container">
        <section class="path-wrap txtOf hLh30"><a href="#" title class="c-999 fsize14">首页</a>
        \
          ...
          <ol class="thr-attr-ol clearfix">
            <li>
              ...
              <aside>
                ...
                <br>
                <h6 class="c-fff f-fM mt10">150</h6>  </aside>
            </li>
            <li>
              <p>&nbsp;</p>
              <aside>
      ...
      <div class="mt20 c-infor-box">
        <article class="fl col-7">
          <section class="mr30">
            <div class="i-box">
              <div>
                <section id="c-i-tabTitle" class="c-infor-tabTitle c-tab-
title">
